...
※ログインせずにご利用になれますが、ログインするとSNS機能（投稿、ユーザフォロー、いいね、コメント、タイムライン等）がご利用になれます。
　右上の「ゲストログイン」ボタンをご利用ください。 
　

### Buddhagram で出来ること

1. 周辺にどんな仏像やお寺があるのかすぐに知ることが出来る（周辺スポット検索機能）
1. 仏像やお寺に特化した体験をシェア（SNS機能）
1. どのお寺でどんな仏像が見られるのか知ることが出来る（仏像、スポット一覧機能）
