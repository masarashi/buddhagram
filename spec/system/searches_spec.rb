...
RSpec.describe 'Searches', type: :system do
  ...
  it 'user searches for users', js: true do
  ...
  it 'user searches for statues', js: true do
  ...
  it 'user searches for spots', js: true do
  ...
  it 'user searches for hashtags', js: true do
  ...
  it 'user searches for non existent object fail', js: true do
    visit search_path
  ...
  it 'user searches for blank fail', js: true do
    visit search_path
    click_on '検索'
    sleep 0.5
