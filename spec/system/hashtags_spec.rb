...
RSpec.describe "Hashtags", type: :system do
  ...
  scenario "user clicks hashtag in text" do
  ...
  scenario "user clicks hashtag in text on timeline" do
    post = FactoryBot.create(:post, :with_hashtags)
  ...
  scenario "user clicks hashtag in text on search form", js: true do
    post = FactoryBot.create(:post, :with_hashtags)
  ...
  scenario "hashtag page is include post with same hashtag" do
    post = FactoryBot.create(:post, :with_hashtags)
